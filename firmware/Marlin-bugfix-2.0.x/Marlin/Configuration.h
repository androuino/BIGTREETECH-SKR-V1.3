...
#define STRING_CONFIG_H_AUTHOR "(Sem, SKR v1.3 config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BIGTREE_SKR_V1_3 //BOARD_RAMPS_14_EFB
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "Sem's 3D Printer"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 58.60, 51.52, 498.87, 158.3 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 3000, 3000, 3, 1000 }
